...
/**
 * Initiate a tus upload
 *
 * @param {string} path The path to the file you wish to upload
 * @param {string} video_uri The video URI that is being uploaded to. Defaults to "vimeo.com/files/me/videos"
 * @param {function} complete_callback The function to be called when the upload completes
 * @param {function} progress_callback The function that is called when the upload progress is updated,
 * @param {function} error_callback The function that is called when the upload returns an error
 * @param {string} filename The name of the file
 * @param {number} Size The size of the file in bytes
 */
Vimeo.prototype.tusUpload = function (path, video_uri, complete_callback, progress_callback, error_callback, filename, size) {
  var _self = this;
  ...
  this.request(options, function(err, upload_link) {
    var file = new tus.Upload(file, {
